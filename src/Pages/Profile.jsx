...
return(
    <div className="relative overflow-hidden w-[412px] h-[917px] mx-auto bg-[#FEF9FE] font-[BYekan]">
      ...
      <div className="relative rounded-[8px] w-[348px] h-[320px] top-[30px] items-center justify-center mx-auto shadow-[4px_4px_12px_rgba(0,0,0,0.25)]">
        ...
        <p dir="rtl" className="relative text-right text-[10px] left-[-50px] font-normal">
        برای تکمیل اطلاعات پروفایل خود، لطفا کد ملی و تاریخ تولد خود را<br /> وارد کنید.
        </p>
        ...
        <input
          className="relative  w-[235px] h-[21px] top-[-30px] rounded-[7px] text-[10px] px-3 font-[BYekan] border-1 border-[#000000] bg-[#FFFFFF] focus:outline-none"
        />
        <p className="relative left-[103px] top-[-40px] text-[11px] font-bold">
            ماه تولد
        </p>
        <input
          className="relative  w-[235px] h-[21px] top-[-50px] rounded-[7px] text-[10px] px-3 font-[BYekan] border-1 border-[#000000] bg-[#FFFFFF] focus:outline-none"
        />
        <p className="relative left-[103px] top-[-60px] text-[11px] font-bold">
            روز تولد
        </p>
        <input
          className="relative  w-[235px] h-[21px] top-[-70px] rounded-[7px] text-[10px] px-3 font-[BYekan] border-1 border-[#000000] bg-[#FFFFFF] focus:outline-none"
        />
      ...
      <div className="relative rounded-[8px] w-[348px] h-[240px] top-[40px] items-center justify-center mx-auto shadow-[4px_4px_12px_rgba(0,0,0,0.25)]">
        ...
        <p dir="rtl" className="relative text-right text-[10px] left-[-50px] font-normal">
        لطفا قبل از ادامه کار با پنل کاربریتان، رشته و پایه خود را بروزرسانی<br /> کنید.
        </p>
        <p className="relative left-[95px] top-[8px] text-[11px] font-bold">
            مقطع تحصیلی
        </p>
        <input
          className="relative  w-[235px] h-[21px] top-[2px] rounded-[7px] text-[10px] px-3 font-[BYekan] border-1 border-[#000000] bg-[#FFFFFF] focus:outline-none"
        />
        <p className="relative left-[108px] top-[-5px] text-[11px] font-bold">
            رشته
        </p>
        <input
          className="relative  w-[235px] h-[21px] top-[-15px] rounded-[7px] text-[10px] px-3 font-[BYekan] border-1 border-[#000000] bg-[#FFFFFF] focus:outline-none"
        />
      ...
      <div className="relative rounded-t-[8px] w-[348px] h-[228px] top-[95px] items-center justify-center mx-auto shadow-[4px_4px_12px_rgba(0,0,0,0.25)]">
